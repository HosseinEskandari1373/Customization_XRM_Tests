...
namespace Customization_XRM.Workflow
{
    public class WorkflowBase : CodeActivity
    {
        ...
        //virtual method
        protected virtual void ExecuteWorkFlowLogic(LocalWorkflowExecution localPluginExecution)
        {
