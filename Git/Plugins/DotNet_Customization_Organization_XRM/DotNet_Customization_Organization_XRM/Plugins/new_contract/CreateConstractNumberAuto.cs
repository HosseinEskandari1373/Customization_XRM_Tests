    ...
    public class CreateConstractNumberAuto : IPlugin
    {
        public void Execute(IServiceProvider serviceProvider)
        {
                ...
                context.InputParameters["Target"] is Entity)
            {
                ...
                if (entity.LogicalName == "new_contract" /*فرم قرارداد*/)
                {
                    if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity)
                    {
                        ...
                        else
                        {
                            ...
                            Entity AutoPost = service.Retrieve("new_contract" /*فرم قرارداد*/, countContract.Id, new ColumnSet(true));
                            ...
                            //new id; 
                            entity.Attributes.Add("new_countcontract" /*شماره قرارداد*/, charFix + "-" + nameProject + "-" + optionVal + "-" + resultYear + "-" + newCounterValue.ToString());
                        }
                    }
                    else
                    {
